...

{
  ...
  # Create .config directory structure for OpenCode
  system.activationScripts.opencode-setup.text = ''
    echo "Setting up OpenCode configuration..." >&2
    mkdir -p /Users/bells/.config/opencode
    ln -sf /etc/opencode/opencode.json /Users/bells/.config/opencode/opencode.json
    chown -R bells:staff /Users/bells/.config/opencode
  '';
